...
contextBridge.exposeInMainWorld("ctfCompass", {
  ...
  getCtf2History: () => ipcRenderer.invoke("ctf2-history"),
  clearCtf2Data: () => ipcRenderer.invoke("ctf2-clear-data"),
  revealCtf2Downloads: () => ipcRenderer.invoke("ctf2-reveal-downloads"),
